...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.load_btn.setGeometry(QtCore.QRect(10, 10, 101, 31))
        self.load_btn.setObjectName("load_btn")
        self.output = QtWidgets.QTextBrowser(self.centralwidget)
        self.output.setGeometry(QtCore.QRect(10, 50, 271, 311))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.load_btn.setText(_translate("MainWindow", "Загрузить строки"))
